...
const (
	...
	GATEWAY_ACTIVE_CONNECTION_REGISTRAR_POLL_DELAY = "Gateway_Active_Connection_Registrar_Poll_Delay"
...
type Config struct {
	...
	GatewayActiveConnectionRegistrarPollDelay time.Duration
...
func (c Config) String() string {
	...
	fmt.Fprintf(&b, "%s: %s\n", GATEWAY_ACTIVE_CONNECTION_REGISTRAR_POLL_DELAY, c.GatewayActiveConnectionRegistrarPollDelay)
...
func GetConfig() *Config {
	...
	options.SetDefault(GATEWAY_ACTIVE_CONNECTION_REGISTRAR_POLL_DELAY, 10*1000)
	...
	return &Config{
		...
		GatewayActiveConnectionRegistrarPollDelay: options.GetDuration(GATEWAY_ACTIVE_CONNECTION_REGISTRAR_POLL_DELAY) * time.Millisecond,
